...
//let firstName = "Sadiq Iqbal Rajar.";
//let study = "Quaid-e-Awam University";
//let department = "Computer Science";
//let message = `Hello Dear ${firstName} I hope you received this message from me.When I heared this, You cleared the your entry test I'm so happy and want to hugg you and celebrate at the time, but I can't to come for this hearted venue due to some issues and I appreciate you and Congratulations Dear on your this success May Allah give you long live and successes.Now I am saying appreciatly that My Brother selected in ${study} in ${department} world which is the King of "Modern World".`;
//console.log(message)
